...
Write-Output "Resolving custom functions..."
...
Write-Output "Custom functions resolved."
...
Write-Output "Resetting template file content..."
Set-Content $TemplateParametersFile -Value $ParameterFileContent
Write-Output "Template file content resetted."